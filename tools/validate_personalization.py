...
def profile_for(difficulty: str, focus: str, seed: int, entity_count: str) -> dict:
    return {
        ...
        "theme": f"{difficulty.title()} scenario for AcmeOps enterprise authorization reviews",
        ...
        "personalization": {
            "business_nouns": ["tenant", "workspace", "customer record"],
            "scenario_names": [f"{difficulty}-factory-scenario"],
            "fixture_field_names": ["tenant_id", "resource_slug"],
            "hidden_test_emphasis": ["tenant isolation", "hardcoding resistance"],
        },
    }
